...
// parseRange parses an HTTP Range header value of the form "bytes=start-" or "bytes=start-end".
// Returns the start offset, optional end offset, and any parsing error.
